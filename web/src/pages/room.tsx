...
export function Room() {
  ...
  function handleShareRoom() {
    ...
    if (navigator.share !== undefined && navigator.canShare()) {
      ...
      toast.info("A url foi copiada para a sua área de transferência");
    }
  }
    ...
    <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
      ...
      <ol className="list-decimal list-outside px-3 space-y-8">
        <li className="ml-4 leading-relaxed text-zinc-100 ">
          ...
          <button
            type="button"
            className="mt-3 flex items-center gap-2  text-orange-400 text-sm font-medium flex-row hover:text-orange-500"
          >
        ...
        <li className="ml-4 leading-relaxed text-zinc-100 ">
          ...
          <button
            type="button"
            className="mt-3 flex items-center gap-2  text-zinc-400 text-sm font-medium flex-row hover:text-zinc-300"
          >
            <ArrowUp className="size-4" />
            Curtir pergunta (123)
          </button>
